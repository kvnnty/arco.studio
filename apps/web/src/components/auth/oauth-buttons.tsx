...
function providerStartUrl(provider: "google" | "github") {
...
export function OAuthButtons() {
  ...
  useEffect(() => {
    void fetch(`${getApiUrl()}/auth/oauth/providers`, { cache: "no-store" })
      .then((response) => response.json())
      .then((payload: { providers?: Array<"google" | "github"> }) => {
      ...
      <div className="grid grid-cols-2 gap-3">
        {providers.includes("google") ? (
          <Button
            ...
            type="button"
            className="w-full"
            render={<a href={providerStartUrl("google")} />}
          >
        ...
        {providers.includes("github") ? (
          <Button
            ...
            type="button"
            className="w-full"
            render={<a href={providerStartUrl("github")} />}
          >
            <svg
              className="size-4"
              viewBox="0 0 24 24"
