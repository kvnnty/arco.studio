...
export const VIDEO_BRIEF_HINT =
  "Brief it like a motion designer: goal, audience/channel, duration, tone, and CTA.";

export const videoTypesMarketing = {
  eyebrow: "Video types",
  title: "Every launch format, one AI motion designer",
  description:
  ...
  footnote:
    "Paste your product URL, pick a format, add screenshots. Arco handles story, pacing, copy, voice, and motion.",
} as const;
...
export const productOwnerPitch = {
  ...
  description:
    "You already know your product better than any freelancer. Give Arco your URL, screenshots, and launch brief, then export launch-ready motion - no After Effects, no agency retainer, no waiting on a designer.",
  bullets: [
    "Replace $500-2,000 freelance motion jobs",
    "Same-day turnaround from brief pack to export",
